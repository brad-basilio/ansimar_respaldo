...
class AdminContactNotification extends Notification
{
    ...
    public static function availableVariables()
    {
        return [
            ...
            'edad' => 'Edad del remitente',
            'modalidad' => 'Modalidad de estudio (Virtual/Presencial)',
    ...
    public function toMail($notifiable)
    {
        ...
        $body = $template
            ? \App\Helpers\Text::replaceData($template->description, [
                ...
                'edad' => $this->message->age ?? 'No especificado',
                'modalidad' => $this->message->modality ?? 'No especificado',
