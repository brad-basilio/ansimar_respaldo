...
const Testimonials = () => {
    ...
    return (
        <section
            id="testimonios"
            className="hidden relative py-20 lg:py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-[#8B1538]/80 overflow-hidden"
        >
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16 lg:mb-20">
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        Historias reales de profesionales que iniciaron su
                        camino en ANSIMAR
                    </p>
                </div>
                            ...
                            <div className="lg:col-span-3 space-y-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-gray-400 ml-2">
                                        Egresado {currentTestimonial.year}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="text-center">
                        <p className="text-4xl lg:text-7xl font-bold text-white">
                            95%
                        </p>
                        <p className="text-gray-400 mt-2">Satisfacción</p>
                    </div>
                    <div className="text-center">
                        <p className="text-4xl lg:text-7xl font-bold text-[#D4AF37]">
                            4.9
                        </p>
