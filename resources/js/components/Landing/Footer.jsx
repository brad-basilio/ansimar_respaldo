...
const socialLinks = [
    {
        icon: Facebook,
        href: "https://www.facebook.com/ansimarperu/",
        label: "Facebook",
    },
    {
        icon: Instagram,
        href: "https://www.instagram.com/ansimar_peru/?hl=es-la",
        label: "Instagram",
    },
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-400 text-lg">
                                ...
                                novedades sobre moda, eventos y oportunidades
                                exclusivas.
                            </p>
                        </div>
                        <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-gray-400 mb-6 leading-relaxed">
                            Más de 15 años formando a los mejores profesionales
                            de la moda en el Perú. Tu sueño, nuestra pasión.
                        </p>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-gray-400">
                                    Pasaje Moquegua 203 Urbanizacion San Felipe
                                    - Distrito De Comas
                                </span>
                            </li>
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a
                                    href="mailto:informes@ansimar.edu.pe"
                                    className="text-gray-400 hover:text-[#D4AF37] transition-colors"
                                >
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-gray-400">
                                    <strong>Horario Presencial</strong>
                                    <br />
                                    Lun - Vie: 9:00 AM - 1:30 PM
                                    <br />
                                    Lun - Vie: 6:00 PM - 10:00 PM
                                    <br />
                                    <br />
                                    <span className="mt-4">
                                        {" "}
                                        <strong>Horario Virtual</strong>
                                        <br />{" "}
                                    </span>
                                    Lun - Vie: 7:00 AM - 1:00 PM
                                    <br />
                                </span>
                            </li>
                        </ul>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-500 text-sm text-center md:text-left">
                            © {new Date().getFullYear()} ANSIMAR Instituto de
                            Moda. Todos los derechos reservados.
                        </p>
